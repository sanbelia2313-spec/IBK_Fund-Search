...
// 이전/이후 마커 앞에 짧은 괄호구가 하나 더 와도 통과시킴. 괄호는 소괄호"(...)" 뿐 아니라
// 대괄호"[...]"로 병기하는 문서도 있어(2026-07-24, 트러스톤 코리아 외화채권 투자설명서:
// "17시[오후5시] 이전") 둘 다 인식하도록 함. 이게 안 걸리면 마커 자체가 전혀 매칭이 안 돼서
// 본문(11.매입,환매,전환절차) 쪽 파싱이 통째로 실패하고, 표지 요약표의 뒤섞인 2단 레이아웃
// 텍스트로 대체 시도하다가 환매 쪽만 우연히 문맥분류에 실패해 "미입력"으로 남는 문제가 있었음.
